    ...
    if (message.error) {
      return (
        <div className="p-4 bg-red-500/20 rounded-xl">
          <p className="text-red-300 text-2xl">{message.error}</p>
          <p className="text-red-200/70">Original question: {message.question}</p>
        </div>
      );
    }
        ...
        <div className="flex">
          <div className="flex-grow">
            <div className="flex items-center gap-3">
              ...
              {message.answer && renderEnglish(message.answer.english)}
            </div>

            {message.answer && renderJapanese(message.answer.japanese)}
          </div>
